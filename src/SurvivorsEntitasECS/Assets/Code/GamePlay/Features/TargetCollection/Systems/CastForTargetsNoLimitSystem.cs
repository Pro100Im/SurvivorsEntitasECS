...
namespace Code.Gameplay.Features.TargetCollection.Systems
{
  public class CastForTargetsNoLimitSystem : IExecuteSystem
  {
    ...
    public void Execute()
    {
      ...
      {
        entity.targetBuffer.Value.AddRange(TargetsInRadius(entity));
    ...
    {
      return _physicsService.CircleCast(entity.worldPosition.Value, radius: entity.radius.Value, entity.layerMask.Value)
        .Select(x => x.id.Value);
    }
  }
}