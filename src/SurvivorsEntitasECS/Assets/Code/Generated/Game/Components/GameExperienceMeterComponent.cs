...
public partial class GameEntity {
    ...
    public void AddExperienceMeter(Code.Gameplay.Features.LevelUp.Behaviours.ExperienceMeter newValue) {
    ...
    public void ReplaceExperienceMeter(Code.Gameplay.Features.LevelUp.Behaviours.ExperienceMeter newValue) {
        var index = GameComponentsLookup.ExperienceMeter;
        var component = (Code.Gameplay.Features.LevelUp.ExperienceMeterComponent)CreateComponent(index, typeof(Code.Gameplay.Features.LevelUp.ExperienceMeterComponent));
        component.Value = newValue;
    ...
    public void RemoveExperienceMeter() {
