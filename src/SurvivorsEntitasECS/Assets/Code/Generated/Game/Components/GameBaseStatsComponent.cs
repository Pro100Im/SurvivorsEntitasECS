...
public partial class GameEntity {
    ...
    public void AddBaseStats(System.Collections.Generic.Dictionary<Code.Gameplay.Features.CharacterStats.Stats, float> newValue) {
    ...
    public void ReplaceBaseStats(System.Collections.Generic.Dictionary<Code.Gameplay.Features.CharacterStats.Stats, float> newValue) {
        var index = GameComponentsLookup.BaseStats;
        var component = (Code.Gameplay.Features.CharacterStats.BaseStats)CreateComponent(index, typeof(Code.Gameplay.Features.CharacterStats.BaseStats));
        component.Value = newValue;
