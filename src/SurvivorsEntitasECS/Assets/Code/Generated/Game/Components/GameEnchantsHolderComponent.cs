...
public partial class GameEntity {
    ...
    public void AddEnchantsHolder(Code.Gameplay.Features.Enchants.Behaviours.EnchantHolder newValue) {
    ...
    public void ReplaceEnchantsHolder(Code.Gameplay.Features.Enchants.Behaviours.EnchantHolder newValue) {
        var index = GameComponentsLookup.EnchantsHolder;
        var component = (Code.Gameplay.Features.Enchants.EnchantsHolderComponent)CreateComponent(index, typeof(Code.Gameplay.Features.Enchants.EnchantsHolderComponent));
        component.Value = newValue;
    ...
    public void RemoveEnchantsHolder() {
