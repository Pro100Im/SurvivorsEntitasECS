...
public partial class GameEntity {
    ...
    public void AddParentAbility(Code.Gameplay.Features.Abilities.AbilityId newValue) {
    ...
    public void ReplaceParentAbility(Code.Gameplay.Features.Abilities.AbilityId newValue) {
        var index = GameComponentsLookup.ParentAbility;
        var component = (Code.Gameplay.Features.Abilities.ParentAbility)CreateComponent(index, typeof(Code.Gameplay.Features.Abilities.ParentAbility));
        component.Value = newValue;
    ...
    public void RemoveParentAbility() {
