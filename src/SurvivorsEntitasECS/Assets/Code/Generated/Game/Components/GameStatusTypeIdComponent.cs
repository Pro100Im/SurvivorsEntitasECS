...
public partial class GameEntity {
    ...
    public void AddStatusTypeId(Code.Gameplay.Features.Statuses.StatusTypeId newValue) {
    ...
    public void ReplaceStatusTypeId(Code.Gameplay.Features.Statuses.StatusTypeId newValue) {
        var index = GameComponentsLookup.StatusTypeId;
        var component = (Code.Gameplay.Features.Statuses.StatusTypeIdComponent)CreateComponent(index, typeof(Code.Gameplay.Features.Statuses.StatusTypeIdComponent));
        component.Value = newValue;
    ...
    public void RemoveStatusTypeId() {
