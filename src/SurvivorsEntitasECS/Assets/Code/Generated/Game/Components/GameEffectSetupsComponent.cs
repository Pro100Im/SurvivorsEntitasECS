...
public partial class GameEntity {
    ...
    public void AddEffectSetups(System.Collections.Generic.List<Code.Gameplay.Features.Effects.EffectSetup> newValue) {
    ...
    public void ReplaceEffectSetups(System.Collections.Generic.List<Code.Gameplay.Features.Effects.EffectSetup> newValue) {
        var index = GameComponentsLookup.EffectSetups;
        var component = (Code.Gameplay.Features.Armaments.EffectSetups)CreateComponent(index, typeof(Code.Gameplay.Features.Armaments.EffectSetups));
        component.Value = newValue;
    ...
    public void RemoveEffectSetups() {
